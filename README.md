...
Anyway, instead of using this utility to open this kind of XML Trace messages, we strongly suggest the user use [RSSL XML Trace Converter](https://github.com/TR-API-Samples/Example.EMARFACPP.Tool.RSSLXMLTraceConverter) instead. The command line utility can convert the file to a new XML file contains the decoded value.
